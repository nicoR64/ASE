...
3. After that, compile the project

```
cmake --build .
```
This will create a new runnable file called `tests` (on windows it will be `tests.exe`)

4. Finally, run the generated runnable file.
