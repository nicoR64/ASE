...
\begin{enumerate}[label=\alph*)]
  \item ~\\
   \begin{figure}[H]
    \centering
    \includegraphics{Tex-Graphics/Aufgabe3a).jpg}
  ...
  \item \begin{itemize}
          \item Pfad 1 ((alter $<$ 18 $||$ student)  ist true):\\ n1 $\rightarrow$ n2 $\rightarrow$ n3 $\rightarrow$ n7
          \item Pfad 2 ((alter $<$ 18 $||$ student) ist false und (mitglied $\&\&$ alter $<$ 65) ist true): \\n1 $\rightarrow$ n2 $\rightarrow$ n4 $\rightarrow$ n5 $\rightarrow$ n7
          \item Pfad 3 (Beide If-Blöcke sind false): \\n1 $\rightarrow$ n2 $\rightarrow$ n4 $\rightarrow$ n6 $\rightarrow$ n7
        \end{itemize}
  \item Testfall 1: \\
        Eingabe: alter 17, mitglied false, student true. $\Rightarrow$ Pfad 1\\
        Ausgabe: true\\

        Testfall 2: \\
        Eingabe: alter 25, mitglied true, student false. $\Rightarrow$ Pfad 2\\
        Ausgabe: true \\

        Testfall 3: \\
        Eingabe: alter 20, mitglied false, student false $\Rightarrow$ Pfad 3\\
        Ausgabe: false \\
