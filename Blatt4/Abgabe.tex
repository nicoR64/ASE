...
\begin{enumerate}[label=\alph*)]
  \item ~\\ \begin{tabular}{|c|c|c c c c|}
        ...
        \end{tabular} \\\\
        \underline{Anomalie:} \\
        Im ersten Pfad entsteht durch die Zeilen 5 und 8 eine d-d Anomalie. Beide Zeilen weißen der Variable einen Wert zu ohne dass diese zwischen den Zeilen referenziert wurde.

  \item Die gefundene d-d Anomalie aus a führt für die Berechnung der Fakultät zu keinem Fehler. So ist sie erstmal nur kosmetischer Natur. Jedoch ist die Fakultät für Zahlen kleiner Null nicht definiert. Die Ausgabe eines Wertes ist somit nie richtig ob dieser Wert nun Eins oder Null ist. Dies hängt aber nicht mit der Anomalie zusammen.
  \item Der Input von n= -1 hat die erwartete Ausgabe von ergebnis = 0. Ausgegeben wird aber  ergebnis = 1. Da die Precondition nicht geprüft wird müssen wir annehmen das es in diesem Programm sinvoll ist bei der Eingabe einer negativen Zahl das Ergebnis auf 0 zu setzen. In diesem Fall führt die Anomalie zu einem Fehler im Programm und ist nicht komsmetischer Natur.
\end{enumerate}
...
\end{lstlisting}
  ...
  \end{lstlisting}
        ...
        \end{center}
        \underline{1. Hotsport: Einrückungen}\\
        ...
        \underline{2. Hotsport: Fehlende Dokumentation}\\
