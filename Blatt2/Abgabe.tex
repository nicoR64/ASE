...
\begin{center}  
    ...
    \item[]
    \includegraphics[width=1.25\linewidth]{./Tex-Graphics/EX02_Komponentendiagramm_2.png}
    \caption{figure}{Komponentendiagramm}

    \item[]
    \includegraphics[width=1.25\linewidth]{./Tex-Graphics/EX02_Deploymentdiagramm_2.png}
    \caption{figure}{Deploymentdiagramm}
\end{center}
